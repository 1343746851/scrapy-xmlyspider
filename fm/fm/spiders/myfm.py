...
class MyfmSpider(CrawlSpider):
    ...
    def get_parse(self, response):
        ...
        for book in bookList:
            bookName = book.xpath('.//a[@class="HxMH album-title lg"]/@title').extract()[0]
            bookUrl = "http://www.ximalaya.com" + book.xpath('.//a[@class="HxMH album-title lg"]/@href').extract()[0]
